...
import { Create_nursefile } from "@/actions/Create_nursefile";

export function Nurse_Profile() {
  ...
  return (
    <CardWrapper headerLabel="Hospital" Label="Nursing profile">
      <Form {...form}>
